...
# Get a list of installed software patches for all devices as Python dictionaries
software_patches = client.get_software_patch_installs()
...
with open('software_patch_installs.json', 'w', newline='') as f:
